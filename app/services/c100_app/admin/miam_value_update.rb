module C100App
  module Admin
    class MiamValueUpdate
      def update_values
        attribute_renames = {adr: %w[previous_attendance ongoing_attendance existing_proceedings_attendance
      ...
      def undo_values
        misc_attribute_renames = {adr: %w[misc_previous_attendance misc_ongoing_attendance
