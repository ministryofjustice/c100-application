...
When(/^I submit the solicitor details$/) do
  ...
  expect(solicitor_personal_details_page.content).to have_header
  ...
  expect(solicitor_address_details_page.content).to have_header
  ...
  expect(solicitor_contact_details_page.content).to have_header
...
Then(/^I should be taken to the solicitor details page$/) do
  ...
  expect(applicant_has_solicitor_page.content).to have_header
end
