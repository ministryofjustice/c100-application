class ChildrenInfoPage < AnyPage
  ...
  section :content, '#main-content' do
    ...
    element :p_2, 'p', text: 'The following questions will ask whether the children have experienced, or are at risk of experiencing, any form of harm.'
