class WithoutNoticeDetailsPage < BasePage
  ...
  section :content, '#main-content' do
    ...
    element :possible_frustrate_yes,
            'input[name="steps_application_without_notice_details_form[without_notice_frustrate]"][value="yes"]', visible: false
    element :possible_frustrate_no,
            'input[name="steps_application_without_notice_details_form[without_notice_frustrate]"][value="no"]', visible: false
    element :possible_frustrate_details,
            'textarea[name="steps_application_without_notice_details_form[without_notice_frustrate_details]"]', visible: false
    element :without_notice_impossible_yes,
            'input[name="steps_application_without_notice_details_form[without_notice_impossible]"][value="yes"]', visible: false
    element :without_notice_impossible_no,
