class InternationalResidentPage < YesNoPage
  ...
  section :content, '#main-content' do
    element :header, 'h1',
            text: 'Do you have any reason to believe that any child, parent or potentially significant adult in the child’s life may be habitually resident in another country abroad or in Scotland or Northern Ireland?'
