class CertificationUploadPage < AnyPage
  include ActiveSupport::Testing::TimeHelpers
  set_url '/steps/miam/certification_upload'

  section :content, '#main-content' do
    element :header, 'h1', text: 'Upload your MIAM certificate'
    element :p_1, 'p', text: 'If you are uploading documents from a computer, name the files clearly. For example, miam-certificate.pdf'
    ...
    element :label_1, 'label', text: 'Select document to upload'
    element :p_3, 'p', text: 'Your document will upload when you click \'Continue\'.'
    element :label_2, 'label', text: 'Select file'
