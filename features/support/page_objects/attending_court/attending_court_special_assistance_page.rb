class AttendingCourtSpecialAssistancePage < BasePage
  ...
  section :content, '#main-content' do
    ...
    element :hearing_loop, 'input[id="steps-attending-court-special-assistance-form-special-assistance-hearing-loop-field"]',
            visible: false
    element :braille_documents,
            'input[id="steps-attending-court-special-assistance-form-special-assistance-braille-documents-field"]', visible: false
    element :advance_court_viewing,
            'input[id="steps-attending-court-special-assistance-form-special-assistance-advance-court-viewing-field"]', visible: false
    element :other_assistance,
  ...
  def submit_special_assistance(hearing_loop: false, braille_documents: false, advance_court_viewing: false,
                                other_assistance: false, special_assistance_details: nil)
