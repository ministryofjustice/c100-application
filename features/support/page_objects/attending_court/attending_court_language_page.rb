class AttendingCourtLanguagePage < BasePage
  ...
  section :content, '#main-content' do
    ...
    element :language_interpreter, 'input[id="steps-attending-court-language-form-language-options-language-interpreter-field"]',
            visible: false
    element :language_interpreter_details, 'textarea[name="steps_attending_court_language_form[language_interpreter_details]"]'
    element :sign_language_interpreter,
            'input[id="steps-attending-court-language-form-language-options-sign-language-interpreter-field"]', visible: false
    element :sign_language_interpreter_details,
            'textarea[name="steps_attending_court_language_form[sign_language_interpreter_details]"]'
