class AttendingCourtSpecialArrangementsPage < BasePage
  ...
  section :content, '#main-content' do
    ...
    element :separate_waiting_rooms,
            'input[id="steps-attending-court-special-arrangements-form-special-arrangements-separate-waiting-rooms-field"]', visible: false
    element :separate_entrance_exit,
            'input[id="steps-attending-court-special-arrangements-form-special-arrangements-separate-entrance-exit-field"]', visible: false
    element :protective_screens,
            'input[id="steps-attending-court-special-arrangements-form-special-arrangements-protective-screens-field"]', visible: false
    element :video_link, 'input[id="steps-attending-court-special-arrangements-form-special-arrangements-video-link-field"]',
            visible: false
  ...
  def submit_special_arrangements(separate_waiting_rooms: false, separate_entrance_exit: false, protective_screens: false,
                                  video_link: false, special_arrangements_details: nil)
