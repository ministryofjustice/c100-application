class DomesticAbusePage < AnyPage
  ...
  section :content, '#main-content' do
    ...
    element :inset_text, '.govuk-inset-text', text: 'Only include abuse by the people in this application or someone connected to them.'
    element :description, 'p', text: 'Domestic violence or abuse includes any incident or pattern of incidents of controlling, coercive or threatening behaviour, violence or abuse between those aged 16 or over'
    element :li_1, 'li', text: 'psychological abuse'
    element :li_2, 'li', text: 'financial abuse'
    element :li_3, 'li', text: 'emotional abuse'
    element :li_4, 'li', text: 'physical abuse'
    element :li_5, 'li', text: 'sexual abuse'
